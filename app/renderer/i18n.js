...
const I18N = {
  ...
  en: {
    ...
    'send.mirror': 'Mirror folder (deletes there)',
    ...
    'send.offline': 'This device is not in this network, and no meeting point is set up.',

    'job.stateRunning': 'running',
    'job.stateAsking': 'waiting for you',
    'job.statePaused': 'paused',
    ...
    'job.willDelete': '{0} file(s) here will be deleted',
    'job.mirrorNothing': 'Mirroring — nothing to remove here',
    'job.deleted': '{0} deleted',
    ...
    'recv.directTitle': 'Reach this device without the device scan',
    'recv.directHint': 'Some routers do not pass the network scan on from Wi-Fi to cable. Then hand one of these lines to the other device and paste it into its address field — it carries the address as well, so it still knows who to expect. One line per network card; pick the one that matches its network.',
    'recv.directCopy': 'Click to copy',
    ...
    'dev.viaMeet': 'Not in this network - reachable via the meeting point {0}',
    'dev.viaMeetShort': 'via meeting point',
    'dev.paired': 'Paired',
  ...
  de: {
    ...
    'send.mirror': 'Ordner abgleichen (löscht drüben)',
    ...
    'send.offline': 'Dieses Gerät ist nicht in diesem Netz, und es ist kein Treffpunkt eingerichtet.',

    'job.stateRunning': 'läuft',
    'job.stateAsking': 'wartet auf dich',
    'job.statePaused': 'pausiert',
    ...
    'job.willDelete': '{0} Datei(en) hier werden gelöscht',
    'job.mirrorNothing': 'Abgleich — hier gibt es nichts wegzuräumen',
    'job.deleted': '{0} gelöscht',
    ...
    'recv.directTitle': 'Dieses Gerät ohne Geräteschau erreichen',
    'recv.directHint': 'Manche Router reichen den Rundruf nicht vom WLAN ins Kabelnetz weiter. Dann gib der Gegenstelle eine dieser Zeilen und lass sie sie ins Anschriftfeld einfügen — die Anschrift steckt mit drin, es bleibt also geprüft, wer antwortet. Eine Zeile je Netzwerkkarte; nimm die, die zum Netz der Gegenstelle passt.',
    'recv.directCopy': 'Zum Kopieren anklicken',
    ...
    'dev.viaMeet': 'Nicht in diesem Netz - erreichbar über den Treffpunkt {0}',
    'dev.viaMeetShort': 'über den Treffpunkt',
  ...
  fr: {
    ...
    'send.mirror': 'Synchroniser le dossier (supprime là-bas)',
    ...
    'send.offline': 'Cet appareil n’est pas dans ce réseau, et aucun point de rencontre n’est configuré.',

    'job.stateRunning': 'en cours',
    'job.stateAsking': 'attend votre réponse',
    'job.statePaused': 'en pause',
    'job.offer': '{0} fichier(s) · {1}',
    'job.accept': 'Accepter',
    'job.decline': 'Refuser',
    'job.pause': 'Pause',
    'job.stop': 'Arrêter',
    'job.resume': 'Reprendre',
    'job.discard': 'Abandonner',
    ...
    'job.willDelete': '{0} fichier(s) seront supprimés ici',
    'job.mirrorNothing': 'Synchronisation — rien à supprimer ici',
    'job.deleted': '{0} supprimé(s)',
    ...
    'recv.directTitle': 'Joindre cet appareil sans la recherche réseau',
    'recv.directHint': 'Certains routeurs ne transmettent pas la recherche du Wi-Fi vers le réseau filaire. Donnez alors une de ces lignes à l’autre appareil et collez-la dans son champ d’adresse — elle contient aussi l’adresse, donc on sait toujours qui doit répondre. Une ligne par carte réseau ; prenez celle qui correspond à son réseau.',
    'recv.directCopy': 'Cliquer pour copier',
    ...
    'dev.viaMeet': 'Hors de ce réseau - joignable via le point de rencontre {0}',
    'dev.viaMeetShort': 'via le point de rencontre',
    'dev.paired': 'Jumelé',
